...
class FileTransferStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListFiles = channel.unary_unary(
                ...
                _registered_method=True)
        self.DriveSpace = channel.unary_unary(
                '/FileTransfer/DriveSpace',
                request_serializer=file__transfer__pb2.Empty.SerializeToString,
                response_deserializer=file__transfer__pb2.Space.FromString,
                _registered_method=True)
...
def add_FileTransferServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'DriveSpace': grpc.unary_unary_rpc_method_handler(
                    servicer.DriveSpace,
                    request_deserializer=file__transfer__pb2.Empty.FromString,
                    response_serializer=file__transfer__pb2.Space.SerializeToString,
            ),
    }
...
class FileTransfer(object):
    ...
    def DriveSpace(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/FileTransfer/DriveSpace',
            file__transfer__pb2.Empty.SerializeToString,
            file__transfer__pb2.Space.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
